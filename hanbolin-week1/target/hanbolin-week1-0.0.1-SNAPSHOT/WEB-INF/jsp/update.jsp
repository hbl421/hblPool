...
<script type="text/javascript">
	$(function(){
		...
		$.post("updateById.do",{zid:zid},function(obj){
			
			$("input[name='zname']").val(obj.zname);
			$("input[name='introduction']").val(obj.introduction);
			
			$("#tid [value='"+obj.type.tid+"']").attr({"selected":true});
...
<body>
	...
	<form method="post" action="update.do">
		...
		植物类别：<select name="type.tid" id="tid">
					<option>请选择</option>
				</select><br><br>
